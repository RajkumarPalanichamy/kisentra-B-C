...
const WhatsAppFloatingButton: React.FC<WhatsAppFloatingButtonProps> = ({
  phoneNumber = '919392938283', // Default phone number from footer
  ...
  return (
    <div
      ...
      style={{
        position: 'fixed',
        bottom: `${bottomPosition}px`, // Positioned above mail button
        right: '30px', // Aligned with mail and scroll buttons
        width: `${buttonSize}px`,
